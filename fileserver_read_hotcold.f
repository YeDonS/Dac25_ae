#
# Hot/cold read workload for filebench.
# Threads are split across hot/cold filesets to create an approximate
# bimodal access distribution.
#
...
echo  "File-server hot/cold read workload loaded"
