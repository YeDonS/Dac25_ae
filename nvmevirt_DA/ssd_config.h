...
#define QLC_4KB_READ_LATENCY_UPPER  ((35760 + 6000) * 25 / 10) 
#define QLC_4KB_READ_LATENCY_MIDDLE ((35760 + 6000) * 35 / 10) 
#define QLC_4KB_READ_LATENCY_LOWER  ((35760 + 6000) * 45 / 10) 

/* QLC 页读延迟：约为 SLC 的 1. 倍 */
#define QLC_READ_LATENCY_TOP    ((36013 - 6000) * 15 / 10) 
#define QLC_READ_LATENCY_UPPER  ((36013 + 6000) * 25 / 10) 
#define QLC_READ_LATENCY_MIDDLE ((36013 + 6000) * 35 / 10)   
#define QLC_READ_LATENCY_LOWER  ((36013 + 6000) * 45 / 10) 
...
//#define QLC_CELL_LEVELS (4)                 /* QLC 有 4 种单元类型 (TOP/UPPER/MIDDLE/LOWER) */
