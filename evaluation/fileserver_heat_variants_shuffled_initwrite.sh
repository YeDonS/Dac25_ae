...
DRIVER="${SCRIPT_DIR}/filebench/fileserver_heat_access_shuffled_initwrite.py"
FILE_TIER_HELPER="${SCRIPT_DIR}/filebench/fileserver_file_tier.py"
RESULT_PREFIX="fileserver_heat_shuffled_initwrite"
...
SHUFFLE_SEED="${SHUFFLE_SEED:-20250401}"
...
run_one_variant() {
...

    {
        ...
        echo "[fileserver_heat_init] init_mode=real_write rank_mode=shuffled shuffle_seed=${SHUFFLE_SEED}"
    } >>"$init_txt"
