...
VARIANTS="${VARIANTS:-die_base_sb die_latency1_sb die_latency2_sb die_latency3_sb die_all_sb}"
...
if [[ "$RUN_FIO" == "1" ]]; then
    export VARIANTS
    export FIO_JOB_FILE
    export FIO_READ_JOBS
    export FIO_WRITE_JOBS
    export FIO_READ_IODEPTH
    export FIO_WRITE_IODEPTH
    export FIO_MEASURE_READ_BYTES
    export FIO_MEASURE_WRITE_BYTES
    export FIO_READ_RATE
    export FIO_WRITE_RATE
    export FIO_READ_RATE_IOPS
    export FIO_WRITE_RATE_IOPS
    export FIO_TEST_PHASE_PATH
