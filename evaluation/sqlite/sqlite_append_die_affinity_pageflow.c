 ...
 *
 * CREATE TABLE ... (id INTEGER PRIMARY KEY, str1 VARCHAR(4096), str2 VARCHAR(4096),
...
#define DEFAULT_WINDOW_TABLES          10U
#define ROW_EST_PAGES            5U
#define DEFAULT_WINDOW_PAGES_PER_TABLE 160U
#define SCAN_ITER_DEFAULT        10U
#define LOGICAL_PAGE_BYTES       4096ULL
#define DEFAULT_INTERLEAVE_PAGES 8000U
...
static void set_gc_nand_timing(int enabled)
{
	...
	int rc = write_string_file(GC_NAND_TIMING_PATH, val);
				...
				unsigned int **heat_out)
{
	...
	printf("[sqlite_init] pageflow_mode=1 rrpad_die_count=%u window_tables=%u window_pages_per_table=%u unit_pages=1(sqlite page)\n",
