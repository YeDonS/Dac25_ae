...
SQLITE_DMESG_GREP=${SQLITE_DMESG_GREP:-"NVMeVirt|nvmev|blocked for more than|hung_task|No free entry|SLOW_PATH|credit scan capped|credit horizon overflow|proc queue full|writeback proc queue full"}
