...
if [[ "${1:-}" == "all" ]]; then
    for v in die_base die_base_sb die_latency1_sb die_latency2_sb die_all_sb die_no2_sb die_base_lru die_no4 die_base2 die_base3 die_no1 die_no1_sb die_no2 die_no3 die_all $ABLATION_VARIANTS; do
        build_one "$v"
    done
    echo ""
